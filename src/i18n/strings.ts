...
export const UI: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    surface2d: '2D',
    surface3d: '3D',
    docTitle: 'mathlet · 200 个公式可视化',
    docDescription: '200 个数学公式的交互式 2D/3D 可视化。极客向，按 L1-L5 分级，14 个领域全覆盖。',
  },
  en: {
    siteTagline: '200 formula visualizations',
    ...
    surface2d: '2D',
    surface3d: '3D',
    docTitle: 'mathlet · 200 formula visualizations',
    docDescription: 'Interactive 2D/3D visualization of 200 mathematical formulas. Geek-oriented, L1-L5 difficulty, 14 domains.',
  },
  es: {
    siteTagline: '200 visualizaciones de fórmulas',
    ...
    surface2d: '2D',
    surface3d: '3D',
    docTitle: 'mathlet · 200 visualizaciones de fórmulas',
    docDescription: 'Visualización interactiva 2D/3D de 200 fórmulas matemáticas. Para entusiastas, dificultad L1-L5, 14 dominios.',
  },
};
