...
export const UI: Record<Lang, Record<string, string>> = {
  zh: {
    siteTagline: '515 个公式 · 点开任意一个开始把玩',
    ...
    surface2d: '2D',
    surface3d: '3D',
    docTitle: 'mathlet · 515 个公式可视化',
    docDescription: '515 个数学公式的交互式 2D/3D 可视化。极客向，按 L1-L5 分级，16 个领域全覆盖。',
    heroTitle: '把公式变成可玩的可视化',
    heroBody: '16 领域 · L1-L5 · 拖动滑块即时看图',
    aboutLink: 'About',
  ...
  en: {
    siteTagline: '515 formulas · pick one and start playing',
    ...
    surface2d: '2D',
    surface3d: '3D',
    docTitle: 'mathlet · 515 formula visualizations',
    docDescription: 'Interactive 2D/3D visualization of 515 mathematical formulas. Geek-oriented, L1-L5 difficulty, 16 domains.',
    heroTitle: 'Math formulas you can play with',
    heroBody: '16 domains · L1–L5 · drag a slider, watch it change',
    aboutLink: 'About',
    feedbackLink: 'Feedback',
  ...
  es: {
    siteTagline: '515 fórmulas · elige una y empieza a jugar',
    ...
    surface2d: '2D',
    surface3d: '3D',
    docTitle: 'mathlet · 515 visualizaciones de fórmulas',
    docDescription: 'Visualización interactiva 2D/3D de 515 fórmulas matemáticas. Para entusiastas, dificultad L1-L5, 16 dominios.',
    heroTitle: 'Fórmulas con las que puedes jugar',
    heroBody: '16 dominios · L1–L5 · mueve un control, ve el cambio',
    aboutLink: 'Acerca',
    feedbackLink: 'Feedback',
...
export const DOMAIN_LABELS_I18N: Record<Lang, Record<Domain, string>> = {
  zh: {
    ...
    vectorfield: '向量场 / 微分几何', cellular: '元胞自动机 / 涌现', biology: '生物 / 基因 / 分子', chemistry: '化学 / 反应 / 分子',
  },
  en: {
    ...
    vectorfield: 'Vector Fields / Diff Geo', cellular: 'Cellular Automata / Emergence', biology: 'Biology / Genes / Molecules', chemistry: 'Chemistry / Reactions / Molecules',
  },
  es: {
    ...
    vectorfield: 'Campos Vectoriales / Geo Dif', cellular: 'Autómatas Celulares / Emergencia', biology: 'Biología / Genes / Moléculas', chemistry: 'Química / Reacciones / Moléculas',
  },
};
