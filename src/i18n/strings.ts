...
export const UI: Record<Lang, Record<string, string>> = {
  zh: {
    siteTagline: '493 个公式 · 点开任意一个开始把玩',
    ...
    surface2d: '2D',
    surface3d: '3D',
    docTitle: 'mathlet · 493 个公式可视化',
    docDescription: '493 个数学公式的交互式 2D/3D 可视化。极客向，按 L1-L5 分级，15 个领域全覆盖。',
    heroTitle: '把数学公式变成可以把玩的可视化。',
    heroBody: '493 个交互式 2D/3D 演示，覆盖代数、几何、微积分、PDE、分形、拓扑、信号、向量场、元胞自动机等 15 个领域，按 L1–L5 分级。每个公式都是一个可调参数的实时画布——拖动滑块，立刻看到形状变化。',
    aboutLink: 'About',
  ...
  en: {
    siteTagline: '493 formulas · pick one and start playing',
    ...
    surface2d: '2D',
    surface3d: '3D',
    docTitle: 'mathlet · 493 formula visualizations',
    docDescription: 'Interactive 2D/3D visualization of 493 mathematical formulas. Geek-oriented, L1-L5 difficulty, 15 domains.',
    heroTitle: 'Math formulas you can actually play with.',
    heroBody: '493 interactive 2D/3D visualizations across 15 domains — algebra, geometry, calculus, PDEs, fractals, topology, signals, vector fields, cellular automata, and more. Graded L1–L5. Every formula is a live canvas with adjustable parameters — drag a slider, watch the shape change.',
    aboutLink: 'About',
    feedbackLink: 'Feedback',
  ...
  es: {
    siteTagline: '493 fórmulas · elige una y empieza a jugar',
    ...
    surface2d: '2D',
    surface3d: '3D',
    docTitle: 'mathlet · 493 visualizaciones de fórmulas',
    docDescription: 'Visualización interactiva 2D/3D de 493 fórmulas matemáticas. Para entusiastas, dificultad L1-L5, 15 dominios.',
    heroTitle: 'Fórmulas matemáticas con las que puedes jugar.',
    heroBody: '493 visualizaciones interactivas 2D/3D en 15 dominios — álgebra, geometría, cálculo, EDPs, fractales, topología, señales, campos vectoriales, autómatas celulares y más. Niveles L1–L5. Cada fórmula es un lienzo en vivo con parámetros ajustables — mueve un control y mira cómo cambia la forma.',
    aboutLink: 'Acerca',
    feedbackLink: 'Feedback',
...
export const DOMAIN_LABELS_I18N: Record<Lang, Record<Domain, string>> = {
  ...
  en: {
    ...
    vectorfield: 'Vector Fields / Diff Geo', cellular: 'Cellular Automata / Emergence', biology: 'Biology / Genes / Molecules',
  },
  es: {
    ...
    vectorfield: 'Campos Vectoriales / Geo Dif', cellular: 'Autómatas Celulares / Emergencia', biology: 'Biología / Genes / Moléculas',
  },
};
