...
export const UI: Record<Lang, Record<string, string>> = {
  zh: {
    siteTagline: '725 个公式 · 点开任意一个开始把玩',
    ...
    surface2d: '2D',
    surface3d: '3D',
    docTitle: 'MATHLET · 725 个公式可视化',
    docDescription: '725 个数学公式的交互式 2D/3D 可视化。极客向，按 L1-L5 分级，22 个领域全覆盖。',
    heroTitle: '把公式变成可玩的可视化',
    heroBody: '22 领域 · L1-L5 · 拖动滑块即时看图',
    aboutLink: 'About',
  ...
  en: {
    siteTagline: '725 formulas · pick one and start playing',
    searchPlaceholder: 'search formulas...',
    ...
    surface2d: '2D',
    surface3d: '3D',
    docTitle: 'MATHLET · 725 formula visualizations',
    docDescription: 'Interactive 2D/3D visualization of 725 mathematical formulas. Geek-oriented, L1-L5 difficulty, 22 domains.',
    heroTitle: 'Math formulas you can play with',
    heroBody: '22 domains · L1–L5 · drag a slider, watch it change',
    aboutLink: 'About',
    feedbackLink: 'Feedback',
  ...
  es: {
    siteTagline: '725 fórmulas · elige una y empieza a jugar',
    ...
    surface2d: '2D',
    surface3d: '3D',
    docTitle: 'MATHLET · 725 visualizaciones de fórmulas',
    docDescription: 'Visualización interactiva 2D/3D de 725 fórmulas matemáticas. Para entusiastas, dificultad L1-L5, 22 dominios.',
    heroTitle: 'Fórmulas con las que puedes jugar',
    heroBody: '22 dominios · L1–L5 · mueve un control, ve el cambio',
    aboutLink: 'Acerca',
    feedbackLink: 'Feedback',
