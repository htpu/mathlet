...
export const UI: Record<Lang, Record<string, string>> = {
  zh: {
    siteTagline: '743 个公式 · 点开任意一个开始把玩',
    ...
    surface2d: '2D',
    surface3d: '3D',
    docTitle: 'MATHLET · 743 个公式可视化',
    docDescription: '743 个数学公式的交互式 2D/3D 可视化。极客向，按 L1-L5 分级，28 个领域全覆盖。',
    heroTitle: '把公式变成可玩的可视化',
    heroBody: '28 领域 · L1-L5 · 拖动滑块即时看图',
    aboutLink: 'About',
  ...
  en: {
    siteTagline: '743 formulas · pick one and start playing',
    searchPlaceholder: 'search formulas...',
    ...
    surface2d: '2D',
    surface3d: '3D',
    docTitle: 'MATHLET · 743 formula visualizations',
    docDescription: 'Interactive 2D/3D visualization of 743 mathematical formulas. Geek-oriented, L1-L5 difficulty, 28 domains.',
    heroTitle: 'Math formulas you can play with',
    heroBody: '28 domains · L1–L5 · drag a slider, watch it change',
    aboutLink: 'About',
    feedbackLink: 'Feedback',
  ...
  es: {
    siteTagline: '743 fórmulas · elige una y empieza a jugar',
    ...
    surface2d: '2D',
    surface3d: '3D',
    docTitle: 'MATHLET · 743 visualizaciones de fórmulas',
    docDescription: 'Visualización interactiva 2D/3D de 743 fórmulas matemáticas. Para entusiastas, dificultad L1-L5, 28 dominios.',
    heroTitle: 'Fórmulas con las que puedes jugar',
    heroBody: '28 dominios · L1–L5 · mueve un control, ve el cambio',
    aboutLink: 'Acerca',
    feedbackLink: 'Feedback',
...
export const DOMAIN_LABELS_I18N: Record<Lang, Record<Domain, string>> = {
  zh: {
    ...
    vectorfield: '向量场 / 微分几何', cellular: '元胞自动机 / 涌现', biology: '生物 / 基因 / 分子', chemistry: '化学 / 反应 / 分子', quantum: '量子 / 波函数', graph: '图论 / 算法', crypto: '密码 / 编码', music: '音乐 / 声学', gr: '广义相对论 / 微分几何', astronomy: '天文 / 轨道 / 恒星', economics: '经济 / 金融 / 增长', statmech: '统计物理 / 系综', fluid: '流体力学 / 涡 / 阻力', chaos: '混沌 / 离散映射', gametheory: '博弈论 / 演化', logic: '逻辑 / 布尔 / SAT',
  },
  en: {
    ...
    vectorfield: 'Vector Fields / Diff Geo', cellular: 'Cellular Automata / Emergence', biology: 'Biology / Genes / Molecules', chemistry: 'Chemistry / Reactions / Molecules', quantum: 'Quantum / Wavefunctions', graph: 'Graph Theory / Algorithms', crypto: 'Cryptography / Coding', music: 'Music / Acoustics', gr: 'General Relativity / Diff Geo', astronomy: 'Astronomy / Orbits / Stars', economics: 'Economics / Finance / Growth', statmech: 'Statistical Mechanics / Ensembles', fluid: 'Fluid Dynamics / Vortex / Drag', chaos: 'Chaos / Discrete Maps', gametheory: 'Game Theory / Evolution', logic: 'Logic / Boolean / SAT',
  },
  es: {
