...
export const UI: Record<Lang, Record<string, string>> = {
  zh: {
    siteTagline: '509 个公式 · 点开任意一个开始把玩',
    ...
    surface2d: '2D',
    surface3d: '3D',
    docTitle: 'mathlet · 509 个公式可视化',
    docDescription: '509 个数学公式的交互式 2D/3D 可视化。极客向，按 L1-L5 分级，15 个领域全覆盖。',
    heroTitle: '把公式变成可玩的可视化',
    heroBody: '15 领域 · L1-L5 · 拖动滑块即时看图',
    aboutLink: 'About',
  ...
  en: {
    siteTagline: '509 formulas · pick one and start playing',
    ...
    surface2d: '2D',
    surface3d: '3D',
    docTitle: 'mathlet · 509 formula visualizations',
    docDescription: 'Interactive 2D/3D visualization of 509 mathematical formulas. Geek-oriented, L1-L5 difficulty, 15 domains.',
    heroTitle: 'Math formulas you can play with',
    heroBody: '15 domains · L1–L5 · drag a slider, watch it change',
    aboutLink: 'About',
    feedbackLink: 'Feedback',
  ...
  es: {
    siteTagline: '509 fórmulas · elige una y empieza a jugar',
    ...
    surface2d: '2D',
    surface3d: '3D',
    docTitle: 'mathlet · 509 visualizaciones de fórmulas',
    docDescription: 'Visualización interactiva 2D/3D de 509 fórmulas matemáticas. Para entusiastas, dificultad L1-L5, 15 dominios.',
    heroTitle: 'Fórmulas con las que puedes jugar',
    heroBody: '15 dominios · L1–L5 · mueve un control, ve el cambio',
    aboutLink: 'Acerca',
    feedbackLink: 'Feedback',
